<?php 
  require_once('./persistence/gamelist_psx.php');
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
  
    <title>PowerGame &mdash; Play Station 1</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <!-- <div class="col-6 col-xl-2">
            <a href="index.php" class="text-black h2 mb-0"><img src="./Images/snes.png" alt="PowerGame" width=146 height=95 ></a>
          </div> -->
    ...
    <!-- <div class="site-blocks-cover overlay inner-page-cover" style="background-Image: url('./Images/console/snes.png');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-2 text-center" data-aos="fade-up">
            <h1>Super Nes</h1>
            <p class="caption">170 jogos / Super Nes</p>
          </div>
        </div>
      </div>
    </div> -->
    ...
    <div class="site-section" data-aos="fade">
      <div class="container">
        <div class="row mb-5">
            <div class="col-12 ">
              <h4 class="site-section-heading text-center">Play Station 1</h4>
            </div>
          </div>
          <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="site-block-half d-lg-flex">
                  <div class="image" style="background-image: url('<?php echo "./roms/psx/".$item['image'];?>')">
                </div>
                <div class="text">
                    <form action="./roms/snes/index.php" method="post" target = "_blank"> 
                      <input type="hidden" name="rom" value="<?php echo $item['path'];?>"> 
                      <input type="hidden" name="id" value="<?php echo $item['id_game'];?>"> 
                      <input type="hidden" name="videogame" value="<?php echo $item['console'];?>"> 
                      <h6><?php echo $item['descr'];?></h6>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Oi, ipsilorium!<br>
              ipsiloriumipsiloriumipsilorium<br> na fotografia.<br>
