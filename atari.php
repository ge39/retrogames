<?php 
  require_once('./persistence/gamelist_atari.php');
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
  
    <title>PowerGame &mdash; Atari</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section" data-aos="fade">
      <div class="container">
        <div class="row mb-5">
            <div class="col-12 ">
              <h4 class="site-section-heading text-center">Atari</h4>
            </div>
          </div>
          <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="site-block-half d-lg-flex">
                  ...
                  <div class="image" style="background-image: url('<?php echo "./roms/atari/".$item['thumbnail'];?>')">
                  
                </div>
                  <div class="text">
                    <form action="./roms/atari2600/index.php" method="post" target = "_blank"> 
