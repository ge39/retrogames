<?php
  require_once('./persistence/gamelist_gba.php');
?>
...
<html lang="pt-br">
  ...
  <!-- Site produzido por André Rodrigues - 2020 - Twitter @andrerodrigues. -->
    <title>PowerGame &mdash; Game Boy Advanced</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <!-- <div class="col-6 col-xl-2">
            <a href="index.php" class="text-black h2 mb-0"><img src="./Images/gba.png" alt="PowerGame" width=146 height=95 ></a>
          </div> -->
    ...
    <!-- <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url('./images/console/gba.png');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-2 text-center" data-aos="fade-up">
            <h1>Game Boy Advanced</h1>
            <p class="caption">jogos / Game Boy Advanced</p>
          </div>
        </div>
      </div>
    </div> -->
    ...
    <div class="site-section" data-aos="fade">
      <div class="container">
        <div class="row mb-5">
            <div class="col-12 ">
              <h4 class="site-section-heading text-center">Game Boy Advanced </h4>
            </div>
          </div>
          <div class="row">
            <?php foreach ($result as $row) {?>
              ...
              <h5><?php echo $row['name'];?></h5>
                <div class="site-block-half d-lg-flex">
                  <div class="image" style="background-image: url('<?php echo "./roms./gba/".$row['thumbnail'];?>')">
                                  
                </div>
                  <div class="text">
                    <form action="./roms/gba/index.php" method="post" target = "_blank" > 
  ...
  <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">Sobre o Games</h3>
              <p>ipsilorium<br>
                  Tenho mais de três décadas de experiência<br> ipsiloriumipsiloriumipsilorium.<br>
                  ipsiloriumipsiloriumipsiloriumipsiloriumipsilo
                </p>
            </div>
          </div>
